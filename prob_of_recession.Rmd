...
```{r}
logit_mod <- glm(USREC_3MOS ~ SPRD_10YCMT_FEDFUNDS +
                   D_UNRATE + 
...
## Probability of Recession (10/01/2022)
...
output <- map_dfc(mods, function(x){
...
```
Relative to the historical baseline, the probability of a recession in the next 3 months is low or close to the historical risk of a recession.